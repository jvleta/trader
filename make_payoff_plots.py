...
class Payoff(object):
    """Base payoff wrapper with plotting helper for option-style payoffs."""

    def __init__(self, exercise_price, name: str = ""):
        """Store strike information and configure default axis labels."""
    ...
    def make_payoff_plot(self, min_asset_price, max_asset_price):
        """Plot payoff over a range of asset prices."""
        asset_prices = np.linspace(min_asset_price, max_asset_price, 1000)
        payout_values =  self.get_payoff(asset_prices)
